...
from proyecto.views import proyecto, getMiembros,setMiembros,crearGrupo,listarRol,editarRol,eliminarRol,eliminarmiembro,editar_rolmiembro,eliminarProyecto
