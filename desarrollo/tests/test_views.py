...
class Test_funcional(StaticLiveServerTestCase):
    ...
    def test_10_verReporte1(self):
        # python manage.py test desarrollo.tests.test_views.Test_funcional.test_10_verReporte1
        GMAIL = 'chapiparrizo@gmail.com'
        PASSWORD = 'panchicarrizo'
        try:
            self.login(GMAIL, PASSWORD)
            ...
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[1]/ul/li[7]/a').click() #boton para entrar al product backlog
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[2]/div/div/div[1]/div/div/div[3]/button').click()#boton para generar reporte de product backlog
            time.sleep(3)
        except:
            self.assertEqual(1, 0, "No se cumplio el flujo de eventos")
            time.sleep(1)
    ...
    def test_11_verReporte2(self):
        # python manage.py test desarrollo.tests.test_views.Test_funcional.test_11_verReporte2
        GMAIL = 'chapiparrizo@gmail.com'
        PASSWORD = 'panchicarrizo'
        try:
            self.login(GMAIL, PASSWORD)
            ...
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[1]/ul/li[5]/a').click()  #boton para entrar en el sprint backlog
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[2]/div/div/button[2]').click() #boton para generar reporte de sprint backlog
            time.sleep(3)
        except:
            self.assertEqual(1, 0, "No se cumplio el flujo de eventos")
            time.sleep(1)
    ...
    def test_12_verReporte3(self):
        # python manage.py test desarrollo.tests.test_views.Test_funcional.test_12_verReporte3
        GMAIL = 'chapiparrizo@gmail.com'
        PASSWORD = 'panchicarrizo'
        try:
            self.login(GMAIL, PASSWORD)
            ...
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[1]/ul/li[9]/a').click()     #boton para ir al historial de sprints
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[2]/div/div/table/tbody/tr/td[3]/button').click()    #boton para ir ingresar a un psrint
            time.sleep(1)
            self.driver.find_element_by_xpath(
                '/html/body/div[2]/div/div/div/section/div/div[2]/div[4]/a/div/div').click()
            time.sleep(3)
        except:
            self.assertEqual(1, 0, "No se cumplio el flujo de eventos")
            time.sleep(1)
